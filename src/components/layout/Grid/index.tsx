...
import type {CSSPropertyGridArea, CSSPropertyGridAutoFlow, CSSPropertyGridColumn, CSSPropertyGridRow, Responsive}
    from "types/styles";
...
const Grid = styled(Box)<GridProps>`
    ...
    ${(props) => toPropValue('gird-template-columns', props.girdTemplateColumns, props.theme)}
