...
function withIconStyle(
    ...
    const IconWithStyle = (props: IconButtonProps) => {
        const {onClick, className, size = 24, ...resr} = props
...
export const IconList = [
    CloseIcon, SearchIcon, CloudUploadIcon, GitHubIcon, PersonOutlineIcon
    , CancelIcon, CheckBoxOutlineBlankIcon, CheckBoxIcon, PersonIcon, ShoppingCartIcon
]